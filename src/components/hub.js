    ...
    return (
        <section className='flex flex-row items-center justify-center flex-wrap mx-5 mt-24'>
            <div className='text-center mb-9'>
                ...
                <button className='cursor-pointer bg-[#4477CE] text-white rounded-xl hover:scale-95 my-9 mr-5 h-12'>
                  <Link className='p-14' to="/login">Sign in</Link>            
                </button>
                <button className='bg-[#512B81] text-white rounded-xl hover:scale-95 my-9 h-12'>
